...
import { defaultOption, defaultChecker, defaultRenderer, EmojiRenderer, defaultDict, EmojiChecker } from 'hypermd/addon/fold-emoji'
...
if (twemoji) {
  ...
  console.error("[hypermd-twemoji] twemoji not found.")
}
